...
class ApiMachineService(BaseModel):
    ...
    checks: Optional[conlist(ApiMachineCheck)] = None
    ...
    ports: Optional[conlist(ApiMachinePort)] = None
    protocol: Optional[StrictStr] = None
    __properties = ["autostart", "autostop", "checks", "concurrency", "force_instance_description", "force_instance_key", "internal_port", "min_machines_running", "ports", "protocol"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiMachineService:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiMachineService:
        """Create an instance of ApiMachineService from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiMachineService.parse_obj(obj)

        _obj = ApiMachineService.parse_obj({
