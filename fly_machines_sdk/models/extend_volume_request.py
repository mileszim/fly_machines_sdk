...
class ExtendVolumeRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtendVolumeRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtendVolumeRequest:
        """Create an instance of ExtendVolumeRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExtendVolumeRequest.parse_obj(obj)

        _obj = ExtendVolumeRequest.parse_obj({
