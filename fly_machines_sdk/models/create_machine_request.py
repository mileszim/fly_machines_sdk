...
class CreateMachineRequest(BaseModel):
    ...
    name: Optional[StrictStr] = Field(None, description="Unique name for this Machine. If omitted, one is generated for you")
    region: Optional[StrictStr] = Field(None, description="The target region. Omitting this param launches in the same region as your WireGuard peer connection (somewhere near you).")
    skip_launch: Optional[StrictBool] = None
    skip_service_registration: Optional[StrictBool] = None
    __properties = ["config", "lease_ttl", "lsvd", "name", "region", "skip_launch", "skip_service_registration"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateMachineRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateMachineRequest:
        """Create an instance of CreateMachineRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateMachineRequest.parse_obj(obj)

        _obj = CreateMachineRequest.parse_obj({
