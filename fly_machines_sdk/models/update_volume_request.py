...
class UpdateVolumeRequest(BaseModel):
    ...
    __properties = ["snapshot_retention"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateVolumeRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateVolumeRequest:
        """Create an instance of UpdateVolumeRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateVolumeRequest.parse_obj(obj)

        _obj = UpdateVolumeRequest.parse_obj({
