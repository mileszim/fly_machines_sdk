...
import fly_machines_sdk.models
from fly_machines_sdk import rest
from fly_machines_sdk.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(fly_machines_sdk.models, klass)
