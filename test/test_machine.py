...
from fly_machines_sdk.models.machine import Machine  # noqa: E501
...
class TestMachine(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Machine:
        ...
        if include_optional:
            return Machine(
                checks = [
                    fly_machines_sdk.models.check_status.CheckStatus(
                        name = '', 
                        output = '', 
                        status = '', 
                        updated_at = '', )
                    ],
                config = fly_machines_sdk.models.api/machine_config.api.MachineConfig(
                    auto_destroy = True, 
                    checks = {
                ...
                created_at = '',
                events = [
                    fly_machines_sdk.models.machine_event.MachineEvent(
                        id = '', 
                        request = fly_machines_sdk.models.request.request(), 
                        source = '', 
                        status = '', 
                        timestamp = 56, 
                        type = '', )
                ...
                id = '',
                image_ref = fly_machines_sdk.models.image_ref.ImageRef(
                    digest = '', 
                    labels = {
                        'key' : ''
                        }, 
