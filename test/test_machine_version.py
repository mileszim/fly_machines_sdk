...
from fly_machines_sdk.models.machine_version import MachineVersion  # noqa: E501
...
class TestMachineVersion(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MachineVersion:
        ...
        """
        model = MachineVersion()  # noqa: E501
        if include_optional:
            return MachineVersion(
                user_config = fly_machines_sdk.models.api/machine_config.api.MachineConfig(
                    auto_destroy = True, 
                    checks = {
