...
```sh
pip install git+https://github.com/mileszim/fly_machines_sdk.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/mileszim/fly_machines_sdk.git`)
